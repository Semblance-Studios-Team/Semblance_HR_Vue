...
<template>
  <card class="employee-card">
    <form @submit.prevent="handleSubmit" enctype="multipart/form-data">
      <br>
      <h2> <span style ="margin-right: 15px;"> Client Information </span>
      ...
      <div class="form-row">
       <base-input
          class="col-md-4"
          name="paidORpending"
          v-model="data.paidORpending"
          type="text"
          label="Paid or Pending Bill For Current Month*"
          placeholder="Paid or Penidng"
          >
