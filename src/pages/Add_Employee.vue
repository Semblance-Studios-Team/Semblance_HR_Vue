...
import { Auth } from 'aws-amplify';
    ...
    let onUpload = (employeePic) => {
      ...
      //https://dad59dxvm7.execute-api.us-east-1.amazonaws.com/admin/s3-upload
...
export default {
  ...
  methods: {
    ...
    async handleSubmit () {
      ...
      axios
        .post("https://dad59dxvm7.execute-api.us-east-1.amazonaws.com/admin/consultants", formValues)
        .then(response => {
          console.log(response);
